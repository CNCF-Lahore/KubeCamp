...
const inlineAppConfig = {
  "nuxt": {
    "buildId": "d768dd0e-1398-450c-9aa8-a3c7cd64cf20"
  }
};
...
const handlers = [
  ...
  { route: '/api/_content/cache.1714865948672.json', handler: _wQhr0P, lazy: false, middleware: false, method: "get" },
