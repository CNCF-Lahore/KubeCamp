import { o as __nuxt_component_0$5, _ as _export_sfc } from '../server.mjs';
import { _ as __nuxt_component_0, u as unwrap, f as flatUnwrap } from './MDCSlot-TohJ07IH.mjs';
import { defineComponent, useSlots, computed, h, useSSRContext } from 'file:///workspace/Kubernetes-Bootcamp/node_modules/vue/index.mjs';
  ...
  setup(props) {
    ...
    return () => {
      ...
      return h(
        ...
        items.map(
          (item) => h("li", [
            h("span", { class: `list-icon ${props.type}` }, h(__nuxt_component_0$5, { name: iconName.value, class: "icon" })),
...
//# sourceMappingURL=List-sxM1M6lG.mjs.map
