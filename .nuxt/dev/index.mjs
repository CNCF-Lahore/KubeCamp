...
import { toString as toString$1 } from 'file:///workspace/Kubernetes-Bootcamp/node_modules/hast-util-to-string/index.js';
...
import { toString } from 'file:///workspace/Kubernetes-Bootcamp/node_modules/mdast-util-to-string/index.js';
...
const bundledThemes = {
"github-dark": () => import('file:///workspace/Kubernetes-Bootcamp/node_modules/shiki/dist/themes/github-dark.mjs').then(r => r.default),
"github-light": () => import('file:///workspace/Kubernetes-Bootcamp/node_modules/shiki/dist/themes/github-light.mjs').then(r => r.default),
};
...
const _FwB4ok = eventHandler(async (event) => {
...
const handlers = [
  ...
  { route: '/api/_mdc/highlight', handler: _FwB4ok, lazy: false, middleware: false, method: undefined },
